...
public class OrderController {
    ...
    private static String PAYMENT_URL = "http://cloud-paymentconsul-service/payment/";
    ...
    @GetMapping("/payment/consulTest")
    public Result zkTest() {
        return restTemplate.getForObject(PAYMENT_URL + "consulTest", Result.class);
    }
}
